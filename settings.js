...
global.SESSION_ID = process.env.SESSION_ID || 'KANGO~VtYFULjQ#VqrojrVhcnkgjtkJdWTRYMtXBjIDAaM37J9BQwT-tC8' 
//Enter your 𝙆𝘼𝙉𝙂𝙊-𝙓𝙈𝘿 session id here; must start with KANGO~

//--------------------[ BOT NAME ]----------------------//

global.botname = process.env.BOT_NAME || 'JON SNOW-𝙓𝙈𝘿' 

//-----------------[ OWNER NUMBER ]------------------//

global.ownernumber = process.env.OWNER_NUMBER || '50949100359' 

//-----------------[ OWNER NAME ]------------------//

global.ownername = process.env.OWNER_NAME || 'JON SNOW' 
...
global.author = process.env.STICKER_AUTHOR_NAME || "JON SNOW" 
